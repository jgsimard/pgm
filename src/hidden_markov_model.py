...
if __name__ == '__main__':
    ...
    print(f"complete_log_likelihood={hmm.complete_log_likelihood(x)}")
    print(f"marginal_log_likelihood={hmm.marginal_log_likelihood(x)}")
    print(f"normalized_negative_complete_log_likelihood={hmm.normalized_negative_complete_log_likelihood(x)}")
    print(f"normalized_negative_marginal_log_likelihood={hmm.normalized_negative_marginal_log_likelihood(x)}")
